...
However I think for learning the *technology git* it is better to learn it once on the console.
...
**GPG & SSH** are very important features for security and authenticity.
